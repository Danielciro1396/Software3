...
public class VentanaReporte extends JFrame {
	...
	public VentanaReporte(String url) {
		...
		ArrayList<Investigador> lista = cv.getInvestigadores();
		...
		JFreeChart jchart = ChartFactory.createBarChart("Artículos Científicos por año (Según CvLAC)", "Año", "Cantidad de publicaciones", dcd, PlotOrientation.VERTICAL, true, true, false);
