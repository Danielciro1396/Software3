...
public class VentanaReporteOrcid extends JFrame {
	...
	public VentanaReporteOrcid(String url) {
		...
		JFreeChart jchart = ChartFactory.createBarChart("Publicaciones por año (Según ORCID)", "Año", "Cantidad de publicaciones", dcd, PlotOrientation.VERTICAL, true, true, false);
